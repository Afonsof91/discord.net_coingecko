...
namespace CryptoBotnet
{
    ...
    class Program
    {
        ...
        public async Task MainAsync()
        {
            ...
            var discordSettings = config.GetSection("DiscordSettings").Get<DiscordSettings>();
            ...
            using (var services = ConfigureServices())
            {
                ...
                // We can read from the settings variable to avoid hard coding.
